...
module WillPaginate
  ...
  class LinkRenderer
    ...
    def to_html
      ...
      links.unshift page_link_or_span(@collection.previous_page, 'btnPrevious', @options[:previous_label])
      links.push    page_link_or_span(@collection.next_page,     'btnNext', @options[:next_label])
